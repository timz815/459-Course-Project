...
router.post("/:id/trades", verifyToken, async (req, res) => {
  try {
    ...
    // --- Verify tournament exists and allows trading ---
    ...
    // --- Find existing holding for this symbol if any ---
    ...
    // --- Save participant (cash + holdings updated atomically) ---
