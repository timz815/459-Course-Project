...
function StockDetail() {
  ...
  if (error || !stock) {
    return (
      <div style={styles.page}>
        <Header />
        <main style={styles.main}>
          <p style={styles.statusMessage}>{error || "Stock not found."}</p>
        </main>
      </div>
    );
  }
  ...
  function CustomTooltip({ active, payload, label }) {
    ...
    return (
      <div style={styles.tooltip}>
        ...
        <p style={{ ...styles.tooltipPrice, color: chartColor }}>
  ...
  return (
    <div style={styles.page}>
      ...
      <main style={styles.main}>
        {/* Back navigation */}
        <nav style={styles.backNav}>
          <button style={styles.backButton} onClick={() => navigate("/stock-market")}>
        ...
        <header style={styles.stockHeader}>
          <div style={styles.titleRow}>
            ...
            <div style={styles.titleRight}>
              ...
              <span style={styles.industryTag}>{stock.industry}</span>
            </div>
          </div>
        ...
        <section style={styles.priceSection}>
          <span style={styles.currentPrice}>{formatPrice(stock.price)}</span>
            ...
            <div style={styles.chartWrapper}>
              <ResponsiveContainer width="100%" height={280}>
                <LineChart data={chartData} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                  <XAxis
                    dataKey="time"
                    tick={{ fill: MUTED, fontSize: 11, fontFamily: "'IBM Plex Mono', monospace" }}
                    tickLine={false}
